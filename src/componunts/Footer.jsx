const Footer = () => {
  return (
    <div className="p-4 px-16 bg-[#172337] text-white ">
      <div className="flex text-left text-xs">
        <ul className="flex-1 p-4 gap-2 flex flex-col">
          <li className="py-2 text-slate-600">ABOUT</li>
          <li>Contact Us</li>
          <li>About Us</li>
          <li>Careers Press</li>
        ...
        <ul className="flex-1 p-4 gap-2 flex flex-col">
          <li className="py-2 text-slate-600">HELP</li>
          <li>Payments</li>
          <li>Shipping</li>
        ...
        <ul className="flex-1 p-4 gap-2 flex flex-col">
          <li className="py-2 text-slate-600"> CONSUMER POLICY</li>
          <li>Cancellation & Returns</li>
          <li>Terms Of Use</li>
          <li>Security</li>
          <li>Privacy</li>
        ...
        <ul className="flex-1 p-4 gap-2 flex flex-col">
          <li className="py-2 text-slate-600">SOCIAL</li>
          <li>Facebook</li>
          <li>Twitter</li>
          <li>YouTube</li>
        </ul>
        <ul className="flex-1 p-4 gap-2 flex ">
          <div className="bg-slate-600 h-[130px] w-1 mx-2"></div>

          <div>
            <li className="py-2 text-slate-600">Mail Us: </li>
            <li>
        ...
        <ul className="flex-1 p-4 gap-2 flex flex-col">
          <li className="py-2 text-slate-600">Registered Office Address:</li>
          <li>
